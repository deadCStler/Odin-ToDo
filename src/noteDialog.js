import { removeNote } from "./noteDOM";

export const createNoteDialog = function (categories, note = null) {
  ...
  if (note) {
    ...
    selectCategory.value = note.category;
